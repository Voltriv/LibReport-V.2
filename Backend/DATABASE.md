...
| `studentId` | String | Required. Unique. Hyphenated format `00-0000-00000` (exactly five digits at the end) is enforced (`STUDENT_ID_REGEX`). |
...
| `adminId` | String | Required. Unique. Follows the same hyphenated student ID pattern (`00-0000-00000`). |
