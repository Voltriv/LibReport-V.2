...
const StudentSignIn = () => {
    ...
    () => [
      {
        ...
        description:
          "Place holds on print titles and request study spaces without lining up at the counter.",
      },
      {
        title: "Access digital resources",
        description:
          "Download PDFs from the ebook collection and keep track of expiring links and due dates.",
      },
      {
        title: "Stay in sync with librarians",
        description:
          "Receive updates when requests are ready and review your visit history in one dashboard.",
      },
    ],
    []
  );
  ...
  return (
    <div className="relative overflow-hidden bg-slate-50 px-4 py-16 sm:py-24">
      <div
        className="absolute inset-x-0 top-0 h-64 bg-gradient-to-b from-brand-green/15 to-transparent"
        aria-hidden="true"
      />

      <div className="relative mx-auto flex max-w-4xl flex-col items-center gap-4 text-center">
        <span className="btn-pill-sm bg-brand-green-soft text-brand-green">
          LibReport Student Portal
        </span>
        <h1 className="text-3xl font-semibold text-slate-900 sm:text-4xl">
          Welcome back!
        </h1>
        <p className="max-w-2xl text-sm text-slate-600 sm:text-base">
          Sign in with your student ID or registered email to manage requests,
          download ebooks, and keep track of your library visits.
        </p>
      </div>
          ...
          <div className="relative hidden bg-gradient-to-br from-brand-green via-brand-greenDark to-[#183321] md:flex md:flex-col md:justify-between">
            ...
            <div className="relative flex h-full flex-col justify-between p-10 text-white">
              <div className="space-y-4">
                <span className="btn-pill-sm bg-white/15 text-white/90">
                  Student Access
                </span>
                <h2 className="text-2xl font-semibold leading-snug">
                  Explore resources curated for every program.
                </h2>
                <p className="text-sm text-white/80">
                  Borrow print and digital titles, reserve spaces, and connect
                  with librarians who can guide your research.
                </p>
              </div>
              <ul className="space-y-3 text-sm text-white/85">
                <li className="flex items-start gap-3">
                  <span className="mt-0.5 inline-flex h-7 w-7 items-center justify-center rounded-full bg-white/20 text-sm font-semibold">
                    ✓
                  </span>
          ...
          <div className="p-8 sm:p-10">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                Use your student ID (00-0000-00000) or your registered email
                address.
              </p>
            </div>
            ...
            <form className="mt-6 space-y-4" onSubmit={onSubmit}>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full rounded-lg bg-brand-green text-white font-medium py-2.5 shadow-sm hover:opacity-90 disabled:opacity-60 disabled:cursor-not-allowed transition"
              >
