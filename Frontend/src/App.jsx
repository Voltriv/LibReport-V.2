    ...
    <Router>
      <div className="App">
        ...
        <Routes>
          ...
          <Route path="/usage-heatmaps" element={<RequireAuth><RequireAdmin><UsageHeatmaps /></RequireAdmin></RequireAuth>} />
          <Route path="/tracker" element={<RequireAuth><RequireAdmin><Tracker /></RequireAdmin></RequireAuth>} />
          ...
          <Route path="/library" element={<RequireAuth><RequireAdmin><BooksLibrary /></RequireAdmin></RequireAuth>} />
          ...
          <Route path="/admins" element={<RequireAuth><RequireAdmin><Admins /></RequireAdmin></RequireAuth>} />
        </Routes>
        </Suspense>
      </div>
    </Router>
