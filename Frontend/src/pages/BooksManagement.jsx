    ...
    <div className="min-h-screen bg-stone-50 dark:bg-stone-950">
      ...
      <main className="px-6 md:pl-8 lg:pl-10 pr-6 py-8 md:ml-80">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-slate-900 dark:text-stone-100">Books Management</h1>
            <p className="text-slate-600 dark:text-stone-400 mt-1">Manage your library's book collection</p>
          </div>
          <div className="flex items-center gap-4">
            ...
            <div className="relative">
              <button onClick={() => setIsDropdownOpen(!isDropdownOpen)} className="inline-flex items-center gap-3 rounded-xl bg-white/90 dark:bg-stone-900/80 ring-1 ring-slate-200 dark:ring-stone-700 px-4 py-2 shadow-lg hover:shadow-xl transition-all duration-200">
        ...
        <section className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
          <div className="rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 ring-1 ring-blue-200 dark:ring-blue-800 p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-2 text-2xl font-bold text-blue-900 dark:text-blue-100">{books.length}</p>
              </div>
          ...
          <div className="rounded-2xl bg-gradient-to-br from-amber-50 to-amber-100 dark:from-amber-900/20 dark:to-amber-800/20 ring-1 ring-amber-200 dark:ring-amber-800 p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-amber-600 dark:text-amber-400">Borrowed</p>
                <p className="mt-2 text-2xl font-bold text-amber-900 dark:text-amber-100">
                  {books.reduce((sum, book) => sum + ((book.totalCopies || 0) - (book.availableCopies || 0)), 0)}
                </p>
              </div>
        ...
        <section>
          ...
          {books.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-slate-500 dark:text-stone-400 mb-6">Get started by adding your first book to the collection.</p>
              <button 
                onClick={() => setIsAddOpen(true)}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {books.map((book) => (
                <div key={book.id} className="group relative bg-white dark:bg-stone-900 rounded-2xl ring-1 ring-slate-200 dark:ring-stone-700 overflow-hidden hover:shadow-xl transition-all duration-300">
                        ...
                        {isDropdownOpen === book.id && (
                          <div className="absolute right-0 mt-2 w-48 rounded-xl bg-white dark:bg-stone-900 ring-1 ring-slate-200 dark:ring-stone-700 shadow-xl p-2 z-50">
                            <button 
                              ...
                              className="w-full text-left rounded-lg px-3 py-2 text-sm text-slate-700 dark:text-stone-300 hover:bg-slate-50 dark:hover:bg-stone-800 transition-colors duration-200 flex items-center gap-2"
                            >
                              <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <button 
                              ...
                              className="w-full text-left rounded-lg px-3 py-2 text-sm text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors duration-200 flex items-center gap-2"
                            >
                              <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  {/* Book Info */}
                  <div className="p-4">
                    <h3 className="font-bold text-slate-900 dark:text-stone-100 text-sm mb-1 line-clamp-2">{book.title}</h3>
                    <p className="text-xs text-slate-600 dark:text-stone-400 mb-3 line-clamp-1">by {book.author}</p>
        ...
        {toast && (
          <div className="fixed bottom-4 right-4 z-50">
            <div className={`rounded-xl px-4 py-3 shadow-lg ring-1 ${
              toast.type === 'success' 
